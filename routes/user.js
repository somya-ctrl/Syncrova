...
const { signup,login,refresh,logout,getuser,updateuser,updatestatus,sendMessage,createChannel,getmessage,
    createServer,getserver,getserverbyid,createchannelinserver,getchannelinserver,joinServer,leaveServer,deleteChannel,editmessage} = require('../controllers/user');
...
router.post("/servers/:id/leave", auth, leaveServer);
